...
const otherArray1 = ['d', 'c', 'a', 'b'];

console.assert(otherArray1.length === 4, 'Test 1: length');
console.assert(array1[2] === otherArray1[1], 'Test 1: a');
console.assert(array1[0] === otherArray1[2], 'Test 1: b');
console.assert(array1[3] === otherArray1[0], 'Test 1: c');
console.assert(array1[1] === otherArray1[3], 'Test 1: d');


const array2 = [false, true, 0, 1, null];
const otherArray2 = [0, null, true, false, 1];

console.assert(otherArray2.length === 5, 'Test 2: length');
console.assert(array2[2] === otherArray2[0], 'Test 2: a');
console.assert(array2[1] === otherArray2[2], 'Test 2: b');
console.assert(array2[0] === otherArray2[3], 'Test 2: c');
console.assert(array2[4] === otherArray2[1], 'Test 2: d');
console.assert(array2[3] === otherArray2[4], 'Test 2: e');
