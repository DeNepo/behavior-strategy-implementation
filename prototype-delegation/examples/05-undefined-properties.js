...
const objectLiteral__proto__hasOwnPropertyA = objectLiteral.__proto__.hasOwnProperty(
  'a'
);
...
const objectLiteral__proto__hasOwnPropertyB = objectLiteral.__proto__.hasOwnProperty(
  'b'
);
