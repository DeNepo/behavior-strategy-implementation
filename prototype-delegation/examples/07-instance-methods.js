...

{
  ...
  const charCodeAtIsInstanceMethod = String.prototype.hasOwnProperty(
    'charCodeAt'
  );
  ...
  const toUpperCaseIsInstanceMethod = String.prototype.hasOwnProperty(
    'toUpperCase'
  );
...

{
  ...
  const hasOwnPropertyIsInstanceMethod = Object.prototype.hasOwnProperty(
    'hasOwnProperty'
  );
