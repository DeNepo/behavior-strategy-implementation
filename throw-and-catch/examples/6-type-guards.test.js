...
/*
  ...
  "type guards" is when a function throws an error if arguments are not the right type
  ...
  There are no exercises for testing type guards in this folder
    head over to function-design where all the secret solutions have type guards
    you can practice writing tests for those guards
    then writing your own guards in your solutions
 ...
 * @throws {TypeError} if a or b are not numbers, or are NaN
 */
